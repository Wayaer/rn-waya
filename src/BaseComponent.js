    ...
    return (
      <TouchView
        ...
        <CustomImage
          ...
          style={[{
            width: Wayaer.getWidth(30),
            height: Wayaer.getWidth(30),
          }, this.props.imageStyle]}/>
        <Text style={[{
          marginLeft: Wayaer.getWidth(10),
    ...
    return (
      <TouchView
        ...
        <CustomImage
          ...
          style={[{
            width: Wayaer.getWidth(23),
            height: Wayaer.getWidth(23),
          }, this.props.imageStyle]}/>
        <CustomButton
          {...this.props}
